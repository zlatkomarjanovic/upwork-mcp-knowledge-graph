...
def proposals_from_raw(raw: dict) -> int | None:
    if raw.get("proposal_count") is not None:
        return raw.get("proposal_count")
    tier = raw.get("proposals_tier") or ""
    tier_map = {
        "Fewer than 5": 3,
        "5 to 10": 7,
        "10 to 15": 12,
...
def job_from_api(raw: dict, keyword: str, group: str) -> dict | None:
    ...
    return {
        ...
        "proposals": proposals_from_raw(raw),
