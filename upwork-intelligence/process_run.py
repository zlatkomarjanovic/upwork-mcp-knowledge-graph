...
def merge_batch_results(paired: list) -> list:
    batch_file = ROOT / "_batch_results.jsonl"
    ...
    SEARCH_FILE.write_text(json.dumps(paired, ensure_ascii=False))
...
def main() -> None:
    ...
    paired = merge_batch_results(paired)
    state = load_state()
